...
def plot_evaluation(data,errors,sorted_reduction_factors,tasks):
    plt.figure(figsize=(12, 8))
    num_reduction_factors = len(sorted_reduction_factors)
    bar_width = 0.8 / num_reduction_factors
    #
    error_kw = {
    #'capsize': 10,  # Adjust cap size if needed
    #'elinewidth': bar_width / 2,  # Adjust line width to match bar width as closely as possible
